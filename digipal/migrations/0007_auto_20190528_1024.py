...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='image',
            name='iipimage',
            field=iipimage.fields.ImageField(storage=personal.storage.PersonalImageStorage(), max_length=200, null=True, upload_to=digipal.iipfield.storage.get_image_path, blank=True),
        ),
    ]
